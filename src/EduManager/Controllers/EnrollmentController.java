...
public class EnrollmentController {
    ...
    public boolean addEnrollment(Enrollment enrollment) {
        try {
            ...
            if (studentEnrollments.stream()
                    .map(e -> groupSubjectController.getGroupSubjectById(e.getGroupSubjectId()))
                    .anyMatch(gs -> gs.getDaysOfWeek().equals(newGroupSubject.getDaysOfWeek()) &&
                            gs.getStartTime().equals(newGroupSubject.getStartTime()) &&
                            gs.getEndTime().equals(newGroupSubject.getEndTime()))) {
